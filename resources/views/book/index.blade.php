                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>IDroom</th><th>IDBook</th><th>Book</th><th>IDreturn</th><th>Return</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($book as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->IDroom }}</td><td>{{ $item->IDBook }}</td><td>{{ $item->book }}</td><td>{{ $item->IDreturn }}</td><td>{{ $item->return }}</td>
                                        <td>
