                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>CodeSubject</th><th>NameSubject</th><th>Sect</th><th>Lecturer</th><th>Room</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($subject as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->CodeSubject }}</td><td>{{ $item->NameSubject }}</td><td>{{ $item->sect }}</td><td>{{ $item->lecturer }}</td><td>{{ $item->room }}</td>
                                        <td>
