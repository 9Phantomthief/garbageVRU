...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">menber {{ $menber->id }}</div>
                    <div class="card-body">
                        ...
                        <a href="{{ url('/menber/' . $menber->id . '/edit') }}" title="Edit menber"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
