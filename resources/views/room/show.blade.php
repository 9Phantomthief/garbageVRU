                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> เลขห้อง </th><td> {{ $room->Room }} </td></tr>
                                    <tr><th> ประเภทห้อง </th><td> {{ $room->type }} </td></tr>
                                    <tr><th> รายละเอียด </th><td> {{ $room->Other }} </td></tr>
                                    <tr><th> รูปภาพ </th><td> {{ $room->image }} </td></tr>
                                    <tr><th> สถานะ </th><td> {{ $room->status }} </td></tr>
                                </tbody>
                            </table>
                        </div>
